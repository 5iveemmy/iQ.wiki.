    ...
    return (
      <div className="w-full relative flex items-center">
        ...
        <input
          type={type}
          className={cn(
            "w-full bg-bg-color dark:placeholder:text-slate-400 py-2 rounded-xl placeholder:text-sm placeholder:text-gray-600 border border-border-faded transition duration-300 ease focus:outline-none focus:border-border-primary",
            StartIcon && "pl-10",
            EndIcon && "pr-9",
            className
          )}
